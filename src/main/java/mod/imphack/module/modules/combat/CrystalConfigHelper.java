...
public class CrystalConfigHelper extends Module {
	...
	public void onUpdate() {
		...
		if(multiplace.isEnabled()) {
			...
			if(ping.getValue() <= 1) ((CrystalAura) Main.moduleManager.getModule("CrystalAura")).multiplacePlus.setEnabled(false);
			else if(ping.getValue() > 1) ((CrystalAura) Main.moduleManager.getModule("CrystalAura")).multiplacePlus.setEnabled(true);
